...
import { useRoqPlatformUserProfiles, useEmployeeCount, useReservationCount, useTableCount } from 'lib/roq';

import { EmployeeListPage as ShowCaseList } from 'pages/employees';

function DashboardPage() {
  const { session } = useSession();

  const employeeStat = useEmployeeCount();
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`employees`} passHref legacyBehavior>
                  <Button
